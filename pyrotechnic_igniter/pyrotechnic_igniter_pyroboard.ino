...
const byte SIG_PIN = 4; //Pin the signal is to be read on
...
const int PIN_COUNT = 4; //Number of items in launchers[]
 ...
 //receiver, the values are usually between 1000-2000. In extremely limited cases,
 //the value may go to an absolute minimum of 500 and an absolute maximum of 2250.
 //The 50% mark is usualy at 1500.
 
Igniter launchers[] = {
  Igniter(0, LIGHT_TIME, 1294),
  Igniter(1, LIGHT_TIME, 1484),
  Igniter(2, LIGHT_TIME, 1674),
  Igniter(3, LIGHT_TIME, 1864)
};
